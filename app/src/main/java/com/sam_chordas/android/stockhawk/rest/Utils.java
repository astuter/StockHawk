...
public class Utils {
  ...
  public static ContentProviderOperation buildBatchOperationHistory(JSONObject jsonObject){
    ...
    try {
      ...
      builder.withValue(QuoteHistoryColumns.DATE, date);
      builder.withValue(QuoteHistoryColumns.CLOSE, jsonObject.getDouble("Close"));
      builder.withValue(QuoteHistoryColumns.SYMBOL_DATE, symbol + date);
